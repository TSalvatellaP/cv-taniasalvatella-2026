...
export const AdobeAeIcon = () => (
  <svg viewBox="0 0 100 100" className="w-full h-full">
    ...
    <text x="50" y="65" fontFamily="Arial" fontSize="45" fontWeight="bold" fill="#D191FF" textAnchor="middle">Ae</text>
  </svg>
);
...
export const AdobePrIcon = () => (
  <svg viewBox="0 0 100 100" className="w-full h-full">
    <rect width="100" height="100" rx="15" fill="#00005B" />
    <text x="50" y="65" fontFamily="Arial" fontSize="45" fontWeight="bold" fill="#31A8FF" textAnchor="middle">Pr</text>
  </svg>
);

export const AeCompIcon = ({ color = "#D191FF" }: { color?: string }) => (
...
export const PrSequenceIcon = () => (
  <svg viewBox="0 0 100 100" className="w-3.5 h-3.5 ml-1 mr-2 shrink-0">
    <rect width="100" height="100" fill="#31A8FF" rx="15" />
